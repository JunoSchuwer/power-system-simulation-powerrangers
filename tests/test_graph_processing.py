...
class TestGraphProcessor(unittest.TestCase):
    ...
    def test_find_downstream_vertices(self):
        ...
        source_vertex_id = 1
        test_graph_find_downstream=GraphProcessor(vertex_ids, edge_ids, edge_vertex_id_pairs, edge_enabled, source_vertex_id)
        with self.assertRaises(IDNotFoundError):
    ...
    def test_find_alternative_edges(self):
        ...
        source_vertex_id = 0
        test_graph_find_alternative=GraphProcessor(vertex_ids, edge_ids, edge_vertex_id_pairs, edge_enabled, source_vertex_id)
        with self.assertRaises(IDNotFoundError):
    ...
    def test_find_alternative_edges_2(self):
        ...
        source_vertex_id = 0
        test_graph_find_alternative_2=GraphProcessor(vertex_ids, edge_ids, edge_vertex_id_pairs, edge_enabled, source_vertex_id)
