...
def optimal_tap_pos(
    input_network_data: str, path_active_power_profile: str, path_reactive_power_profile: str, mode=0, number_threads=1
):
    """
...
VALUE_TAP_OPTIMAL_RESULTS = optimal_tap_pos(
    PTH_INPUT_NETWORK_DATA , PTH_ACTIVE_PROFILE, PTH_REACTIVE_PROFILE, mode=0, number_threads=0
)
